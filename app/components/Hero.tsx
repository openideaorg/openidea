  ...
  <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
      ...
      <div className="text-center bg-[#162322] border border-emerald-400/30 rounded-xl p-6 shadow-md">
        ...
        <p className="mt-2 text-base text-teal-100/70">
          Connect with people, not just code/resources. Feedback, help, mentorship, real team formation
        </p>
      </div>
      <div className="text-center bg-[#162322] border border-emerald-400/30 rounded-xl p-6 shadow-md">
        ...
        <p className="mt-2 text-base text-teal-100/70">
          Everything you build, unless private, is instantly reusable by others
        </p>
      </div>
    </div>
  </div>
...
<section className="py-20 bg-gradient-to-br from-[#11271b] via-[#101a15] to-[#183c26] text-white relative">
  <div className="absolute inset-0 pointer-events-none">
    <div className="absolute left-1/3 top-10 w-[500px] h-[220px] bg-gradient-radial from-emerald-400/20 to-transparent blur-2xl" />
  </div>
  <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <h2 className="text-center text-3xl sm:text-4xl font-extrabold text-transparent bg-gradient-to-r from-emerald-300 via-cyan-400 to-teal-300 bg-clip-text animate-glow drop-shadow-neon mb-2">
      Platform Impact
    </h2>
    <p className="mt-3 text-center text-lg text-teal-100/80 font-medium">
      Real numbers from our growing ecosystem
    </p>
    <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
      <div className="text-center bg-[#192527] border border-emerald-400/30 rounded-xl p-10 shadow-lg">
        <div className="text-5xl font-extrabold text-neon-green drop-shadow-neon">10M+</div>
        <div className="mt-2 text-lg font-medium text-teal-100/80">Open Resources Indexed</div>
      </div>
      <div className="text-center bg-[#192527] border border-emerald-400/30 rounded-xl p-10 shadow-lg">
        <div className="text-5xl font-extrabold text-neon-green drop-shadow-neon">50K+</div>
        <div className="mt-2 text-lg font-medium text-teal-100/80">Active Builders</div>
      </div>
      <div className="text-center bg-[#192527] border border-emerald-400/30 rounded-xl p-10 shadow-lg">
        <div className="text-5xl font-extrabold text-neon-green drop-shadow-neon">1000+</div>
        <div className="mt-2 text-lg font-medium text-teal-100/80">Projects Launched</div>
      </div>
      <div className="text-center bg-[#192527] border border-emerald-400/30 rounded-xl p-10 shadow-lg">
        <div className="text-5xl font-extrabold text-neon-green drop-shadow-neon">100+</div>
  ...
  <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
      ...
      <div className="bg-[#192527] p-6 rounded-xl border border-cyan-400/30 shadow-md">
        ...
        <p className="mt-4 text-teal-100/80">
          AI detects and links related resources across silos. Surfaces non-obvious combinations for innovation.
        </p>
      </div>
...
<section className="py-20 bg-gradient-to-br from-[#152624] via-[#12362f] to-[#1b2a26] text-white relative">
  ...
  <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="lg:text-center mb-12">
      <h2 className="text-base font-semibold tracking-wide uppercase text-cyan-300">Questions</h2>
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-teal-400/30 bg-[#182925]/80 shadow hover:shadow-[0_0_14px_#30ffb08f] transition">
        <button className="w-full px-6 py-4 text-left flex justify-between items-center focus:outline-none">
          <span className="text-lg font-medium text-white">What types of projects can launch on ECOSYZ?</span>
      ...
      <div className="rounded-lg border border-teal-400/30 bg-[#182925]/80 shadow hover:shadow-[0_0_14px_#30ffb08f] transition">
        <button className="w-full px-6 py-4 text-left flex justify-between items-center focus:outline-none">
          <span className="text-lg font-medium text-white">Why is everything open source?</span>
          <i className="fas fa-plus text-cyan-400"></i>
        </button>
      </div>
      <div className="rounded-lg border border-teal-400/30 bg-[#182925]/80 shadow hover:shadow-[0_0_14px_#30ffb08f] transition">
        <button className="w-full px-6 py-4 text-left flex justify-between items-center focus:outline-none">
          <span className="text-lg font-medium text-white">How does the AI matching work?</span>
          <i className="fas fa-plus text-cyan-400"></i>
        </button>
      </div>
    </div>
