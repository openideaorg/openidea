      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          <div className="bg-[#192527] p-6 rounded-xl border border-emerald-400/30 shadow-md">
            ...
            <p className="mt-4 text-teal-100/80">
              NLP models tag new resources with domains, technologies, methods,
              outcomes, licenses—without manual effort. Detects "hidden"
              connections.
            </p>
          </div>
          <div className="bg-[#192527] p-6 rounded-xl border border-purple-400/30 shadow-md">
            ...
            <p className="mt-4 text-teal-100/80">
              LLMs auto-summarize research papers, datasets, or code repos into
              1-minute reads or bullet points. Generate customized weekly
              digests.
            </p>
          </div>
          <div className="bg-[#192527] p-6 rounded-xl border border-cyan-400/30 shadow-md">
